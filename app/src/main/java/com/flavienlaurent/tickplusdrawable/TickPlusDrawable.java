...
/**
 * Created by Ohoon on 2014-11-05.
 */
...
public class TickPlusDrawable extends Drawable {
    ...
    public TickPlusDrawable(int strokeWidth, int tickColor, int plusColor,boolean mode) {
    ...
    private void setupPaintsTick() {
        mLinePaint = new Paint(ANTI_ALIAS_FLAG);
        mLinePaint.setStyle(Paint.Style.STROKE);
        mLinePaint.setColor(mTickColor);
        mLinePaint.setStrokeWidth(mStrokeWidth);
        mLinePaint.setStrokeCap(Paint.Cap.ROUND);

        mBackgroundPaint = new Paint(ANTI_ALIAS_FLAG);
        mBackgroundPaint.setStyle(Paint.Style.FILL);
        mBackgroundPaint.setColor(mPlusColor);
    }
    ...
    private void setTickMode(){
        mPoints[0] = mBounds.left;
        mPoints[1] = mBounds.centerY();
        mPoints[2] = mBounds.centerX();
        mPoints[3] = mBounds.bottom;
        mPoints[4] = mBounds.right;
        mPoints[5] = mBounds.centerX()/2;
        mPoints[6] = mBounds.centerX();
        mPoints[7] = mBounds.bottom;
    }
    ...
    public void setToggleCheck(boolean b){
//        animateTick();
    }
